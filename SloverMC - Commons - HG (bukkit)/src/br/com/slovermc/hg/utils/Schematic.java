...
import br.com.slovermc.hg.jnbt.ByteArrayTag;
import br.com.slovermc.hg.jnbt.CompoundTag;
import br.com.slovermc.hg.jnbt.DataException;
import br.com.slovermc.hg.jnbt.NBTInputStream;
import br.com.slovermc.hg.jnbt.ShortTag;
import br.com.slovermc.hg.jnbt.Tag;
...
public class Schematic {
	...
	public void removeColiseu() { 
		for (Block blocks : Manager.getInstance().coliseu) { 
			blocks.setType(Material.AIR);
			blocks.getDrops().clear();
		}
	}
