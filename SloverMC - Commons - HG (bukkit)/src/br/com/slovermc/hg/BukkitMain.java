...
import br.com.slovermc.gladiator.tagsapi.MainAPI;
import br.com.slovermc.gladiator.tagsapi.NametagAPI;
...
import br.com.slovermc.hg.commands.cTagCMD;
...
import br.com.slovermc.hg.commands.cMiniSloverCMD;
import br.com.slovermc.hg.commands.cPingCMD;
...
public class BukkitMain extends JavaPlugin implements PluginMessageListener {
	...
	private void registerCmds() {
		getCommand("minislover").setExecutor(new cMiniSloverCMD());
		...
		getCommand("ping").setExecutor(new cPingCMD());
		...
		getCommand("tag").setExecutor(new cTagCMD());
	}
	...
	public void registerHabilitys() {
		...
		Bukkit.getPluginManager().registerEvents(new NametagAPI(), this);
	...
	public void registerEvents() {
		...
		Bukkit.getPluginManager().registerEvents(new cDanoCMD(), this);
